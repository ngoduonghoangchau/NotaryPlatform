...
using NotaryPlatform.Application.Shared.Models.Pagination;
...
public static class QueryableExtensions
{
    ...
    /// </summary>
    public static async Task<Application.Shared.Models.Pagination.PagedResult<T>> ToPagedResultAsync<T>(
        this IQueryable<T> query,
        ...
        CancellationToken ct = default)
    {
        ...
        return Application.Shared.Models.Pagination.PagedResult<T>.Create(
